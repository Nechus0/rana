    ...
    window.__TAURI_INTERNALS__ = {
      invoke: async (cmd, args) => {
        ...
        if (cmd === 'get_profile') return {
          praxis: { name: 'Praxis Dr. Rana' },
          behandler: { name: 'Dr. Rana' },
          verfahren: { art: 'vt', setting: 'einzel', qualifikation: 'aerztlich' },
          layout: {},
          api: { model: 'Opus' },
          budget: { monthly_eur: 50, daily_reports: 10 },
          eingerichtet: true
        };
        if (cmd === 'list_patients') return [
          { id: '1', label: 'Max Mustermann', chiffre: 'M.M.', report_count: 2 },
          { id: '2', label: 'Erika Musterfrau', chiffre: 'E.M.', report_count: 1 }
        ];
